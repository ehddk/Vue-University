    ...
    <div id="content" >
     <div class="lnb">
      ...
      <ul id="menus">
            ...
            <li class="menu_2">
                <router-link to="/save">학교 인증</router-link>
            </li>
            <li class="menu_3">
        ...
        <div class="detail">
          <div class="detail_title">
            ...
            <div class="list">
                <h3>관심대학</h3>
                <ul class="tabs">
                    <li class="tab1" :class="{active: activeTab === 'tab1'}" @click="activeTab = 'tab1'" >
                        일반대학
                    </li>
                    <li class="tab2" :class="{active: activeTab === 'tab2'}" @click="activeTab = 'tab2'">
                        전문대학
                    </li>
                ...
                <!--전문대학 -->
                <div class="list_table" v-if="activeTab === 'tab2'">
                    <table class="list2">
                        <colgroup>
                            <col style="width:5%">
                            <col style="width:25%">
